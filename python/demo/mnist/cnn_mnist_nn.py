...
# refs : https://github.com/mari-linhares/mnist-android-tensorflow

logs_path = '/tmp/logs/mnist'

# mnist.train = 55,000 input data
# mnist.test = 10,000 input data
# mnist.validate = 5,000 input data
mnist = input_data.read_data_sets("'../../dataset/MNIST/MNIST_data/", one_hot=True)
